          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <motion.button
                ...
                className="p-2 text-[#B0B3C6] hover:text-[#FFD700] transition-colors"
              >
              ...
              <motion.button
                ...
                className="p-2 text-[#B0B3C6] hover:text-[#FFD700] transition-colors relative"
              >
        ...
        {showSearch && (
          ...
          >
            <motion.div
              ...
              className="bg-[#1A1D23] w-full max-w-lg p-4 rounded-lg shadow-lg"
            >
              <input
                type="text"
                placeholder="Search..."
                className="w-full p-3 rounded bg-[#0A0A0C] text-white border border-[#FFD700]/30 focus:outline-none focus:ring-2 focus:ring-[#FFD700]"
              />
            </motion.div>
          </motion.div>
        )}
      ...
      <AnimatePresence>
        {showNotifications && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -10 }}
            className="absolute right-8 top-16 w-64 bg-[#1A1D23] border border-[#FFD700]/20 rounded-lg shadow-lg z-50"
          >
            <div className="p-4 text-sm text-[#FFD700] border-b border-[#FFD700]/20">
              Notifications
            </div>
            <div className="max-h-60 overflow-y-auto">
              <div className="p-3 text-[#B0B3C6] hover:bg-[#0A0A0C]">New offer on Bikes!</div>
              <div className="p-3 text-[#B0B3C6] hover:bg-[#0A0A0C]">20% off Scooters this week</div>
              <div className="p-3 text-[#B0B3C6] hover:bg-[#0A0A0C]">Your subscription is expiring soon</div>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
