  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-dark text-white py-16">
        {/* ...Hero and filters code remains unchanged... */}
      </section>

      {/* Category Tabs */}
      <section className="py-8 border-b">
        {/* ...Category tabs code remains unchanged... */}
      </section>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-8">
            {/* ...Sort and header code unchanged... */}
          </div>
                  ...
                  <Card className="h-full hover:shadow-xl transition-all duration-300 overflow-hidden">
                    ...
                    <div className="relative">
                      {product.video ? (
                        ...
                        <div className="aspect-[4/2] bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
